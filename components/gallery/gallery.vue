<template>
    <div v-if="this.images !== null" class="gallery flex flex-center">
        <div class="slider flex flex-center row">
            <div class="row">
                <div v-for="image in images" :key="image" class="col flex flex-center">
                    ...
                    <video v-if="!isImage(image)" :src="image" alt="Video von der Ausstellung"
                           @click="selectedImage = image">
                    </video>
                </div>
            </div>
        ...
        <div class="preview flex flex-center">
            ...
            <video v-if="!isImage(selectedImage)" :src="selectedImage" alt="Preview Video for the Slider" class="image"
                   controls></video>
        </div>
    </div>
