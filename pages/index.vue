<template>
  <main class="root flex flex-center">
    ...
    <section style="margin:0;">
      ...
      <div class='embed-container' data-page-width='304' data-page-height='640' id='ypembedcontainer'>
        <iframe src="https://www.yumpu.com/de/embed/view/r3PNoFtjw0UbVyOQ" frameborder="0" allowfullscreen="true"
                style="border: 1px solid #333333;" allowtransparency="true"></iframe>
        <br><a href="https://www.yumpu.com/de/document/view/65154528/vostellungsfolder-okay"
               title="Vostellungsfolder-OKAY" target="_blank">Vostellungsfolder-OKAY</a></div>
    </section>
  </main>
</template>
